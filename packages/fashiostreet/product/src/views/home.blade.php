   ...
   <div class="home_section1">
     <div class="row">
      <div class="col-md-6 col-sm-6 col-xs-6">
        <a href="#"><img src={{ asset('assets/img/moonfood.png') }} class="img-responsive" style="border-radius: 3px;height: 150px;width: 150px"></a>
      </div>
      <div class="col-md-6 col-sm-6 col-xs-6">
        <a href="https://play.google.com/store/apps/details?id=in.moonfood.android" target="_blank" class="download-app_btn">DOWNLOAD OUR APP TO ORDER</a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-8 home_headline">
        <div class="home_headline-div">
          Get Breakfast and Snacks Free Home Delivered
        </div>
        ...
        <div style="font-size: 18px;font-weight: 700;padding-top: 20px">
          Right Now In : Kolhapur (2 Km from CSIBER Chowk)
        </div>
      </div>
    </div>
    </div>
